...
function SavingsZone() {
    ...
    useEffect(() => {
        async function API(){
            try{
                const response = await fetch('https://partner.shopeemobile.com/api/v2/product/get_category?partner_id=851249&timestamp=1654673582&shop_id=1001094&access_token=367a0a8eb9d1837cbf7c43b587a0faa4&sign=a40fc50a08c382eeee08e2eb00deb8464c6fdcbe4f1c271e033cdbca3ded4d5b&language=zh-hans');
                if(!response.ok){
    ...
    return (
        <Zone>
            <ZoneAlignment>
                ...
                <HighLightsZone>
                    {Highlights.map(item => <HighlightsElement key={item.name}>
